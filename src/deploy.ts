...
const zkConfigPath = path.resolve(__dirname, '..', 'contracts', 'managed', 'nightroom');

// Load compiled contract
const contractPath = path.join(zkConfigPath, 'contract', 'index.js');
const nightroom = await import(pathToFileURL(contractPath).href);

const compiledContract = CompiledContract.make('nightroom', nightroom.contract).pipe(
